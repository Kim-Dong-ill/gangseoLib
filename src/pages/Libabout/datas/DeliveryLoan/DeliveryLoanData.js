      ...
      <div className="cntWrapBox">
        ...
        <div className="cntTextBox">
          <div>
            ...
            <li className="textBoxType2">
              <span>신청자격 :</span> 보건복지부 등록 장애인, 국가보훈처 등록
              국가유공 상이자, 국민건강보험공단 인정 장기요양 대상자인 대출회원
            </li>
            <li className="textBoxType2">
              <span>이용방법 :</span> 도서관 회원가입 – 책나래 홈페이지 회원가입
              – 소속도서관 승인 - 이용
            </li>
            <li className="textBoxType2">
              <span>대출(반납) :</span>
        ...
        <div className="cntTextBox">
          <div>
            ...
            <li className="textBoxType2">
              ...
              → 강서도서관 소장자료 검색 → "대출 가능여부" 확인 → 서명 클릭 →
              "택배대출 신청" 버튼 클릭 → 택배비용 안내문 "확인" 버튼 클릭 →
              배송지 확인 후 "신청" 버튼 클릭
            </li>
            <li className="textBoxType2">
              <span>대출비용 :</span> 이용자 부담 (1인 대출권수 범위 내 착불
              4,500원). 단 육로 이외 지역 추가 운임 발생
            </li>
            <li className="textBoxType2">
              <span>반납방법 :</span> 자료실 방문 또는 택배 반납
              <div>
                <li className="textBoxType3">
                  택배로 반납할 경우 택배비 선불 지급 (※선택한 택배업체별로
                  요금이 다를 수 있습니다.)
                </li>
                <li className="textBoxType3">
                  택배 도착일로 반납처리 되므로 택배접수-배송 소요기간을
                  고려하여 '반납예정일'보다 먼저 '반납신청'을 해야 함.
                </li>
              </div>
            </li>
            <li className="textBoxType2">
              <span>반납주소 :</span> 우)07669 서울시 강서구 등촌로 51나길 29
              인문사회자연과학실
            </li>
          </div>
        </div>
      ...
      <div className="cntWrapBox">
        ...
        <div className="cntTextBox">
          <div>
            ...
            <li className="textBoxType2">
              <span>대출도서 :</span> 일반도서(단, 귀중자료, 참고자료(서지류,
              사전류, 도감류 등), 기타 대출제한이 필요하다고 인정되는
              자료,도서검색 시 소장된 자료실이 '순회문고'로 구분된 자료 등은
              제외)
            </li>
            <li className="textBoxType2">왕복 택배비 결제하기</li>
            <li className="textBoxType2">
              <span>공공도서관 및 대학도서관 자료 :</span> 5,540원 중 1,700원
              결제(서울시 지원금 3,840원)
            </li>
            <li className="textBoxType2">
            ...
            <li className="textBoxType2">
              <span>이용방법 :</span> 강서도서관 회원으로 국가표준상호대차서비스
              홈페이지에 회원가입 신청 후 이용
            </li>
            <li className="textBoxType2">
              <span>책바다 상호대차서비스 이용안내</span>
              <br />
               https://books.nl.go.kr(국립중앙도서관 상호대차서비스) :
              회원승인요청->상호대차신청->요금결제->대출·반납
            </li>
            <li className="textBoxType2">
              <span>※ 상호대차(책바다) 문의처 :</span> ※ 상호대차(책바다) 문의처
              : 어문학·간행물실 ☎3219-7040~2
            </li>
          </div>
        </div>
      </div>
