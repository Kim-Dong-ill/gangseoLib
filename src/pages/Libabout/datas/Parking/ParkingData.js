        ...
        <div className="cntWrapBox">
          ...
          <div className="cntTextBox">
            ...
            <div>
              ...
              <li className="textBoxType2">
                <span>무료 주차 :</span> 최초 1시간까지 무료(1일 1회에 한함)
              </li>
              <li className="textBoxType2">
                <span>요금징수 :</span> 1시간 초과 시 매 5분당 100원
                <br />
                (무료주차 시간 이후 초과요금은 주차권에 의해서 퇴관 시 정산함)
              </li>
            </div>
            <div>
              ...
              <li className="textBoxType2">
                식당은 따로 운영되지 않으며 개인 도시락 취식 및 멀티자판기
                사용가능합니다.
              </li>
            </div>
            <div>
              ...
              <li className="textBoxType2">
                <span>주차면수 :</span> 10면(장애인 주차면수 1면 포함)
              </li>
              <li className="textBoxType2">요일제 적용</li>
            </div>
          </div>
        </div>
        {/* End:큰 단락 복사 사용시 */}
